...
import cz.mendelu.pef.pokeprojekt.ui.theme.basicMargin
import cz.mendelu.pef.pokeprojekt.ui.theme.basicTextColor
import cz.mendelu.pef.pokeprojekt.ui.theme.getBackgroundColor
        ...
        topBar = {
            if (topBarText != null) {
                TopAppBar(
                    ...
                    actions = actions,
                    modifier = Modifier.background(Color(0xFF1874A7)),
                    navigationIcon = {
                        if (onBackClick != null) {
                    ...
                    colors = TopAppBarDefaults.topAppBarColors(containerColor = Color(0xFF1874A7))
                )
            }
        }
    ) {
